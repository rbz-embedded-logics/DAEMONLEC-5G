...
void ADE7880_ReadPhaseVRMS(int device, uint8_t channel, float *measure)
{
  uint16_t target_reg;
  ...
  /*measure_temp = (measure_temp & 0xFFFFFF) * TRANSFORMER_RATIO;*/
  *measure = (float)measure_temp / 1.0;
}

void ADE7880_ReadPhaseIRMS(int device, uint8_t channel, float *measure)
{
  uint16_t target_reg;
  int32_t measure_temp = 0;
...
void ADE7880_ReadPhaseActiveWH(int device, uint8_t channel, float *measure)
{
  uint16_t target_reg;
  int32_t measure_temp = 0;
...
void ADE7880_ReadPhaseActivePower(int device, uint8_t channel, float *measure)
{
  uint16_t target_reg;
  int32_t measure_temp = 0;
...
void ADE7880_ReadPhaseAparentPower(int device, uint8_t channel, float *measure)
{
  uint16_t target_reg;
  int32_t measure_temp = 0;
...
void ADE7880_ReadPhasePowerFactor(int device, uint8_t channel, float *measure)
{
  uint16_t target_reg;
  int32_t measure_temp = 0;
